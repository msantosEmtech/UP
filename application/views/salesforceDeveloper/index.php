                ...
                <div class="col-lg-7 order-lg-1 align-self-center">
                    <div class="banner-inner text-center text-lg-left mt-5 mt-lg-0">
                        <h1 class="b-animate-2 title font-Laurentiareg" style="line-height:1;color:#000000;">
                            Salesforce <br>
                            <span style="color:#B69256">Developer</span>
                        </h1>
                        <h4 class="b-animate-1" style="color:#000000;">Conviérte en un experto en el desarrollo <br>de<span class="font-Novbold"> soluciones tecnológicas personalizadas.</span></h4>
                        <div class="mt-4">
                            ...
                            <a style="color: #B69256!important;border: 2px solid #B69256!important;" class="btn btn-border-black m-2 b-animate-3" href="<?= base_url('SalesforceDeveloper/downloadSyllabus') ?>">Descargar Syllabus</a>
                        </div>
                    ...
                    <div class="col-lg-6 my-auto">
                        <div class="about-inner-wrap pl-xl-4 pt-3 pt-lg-0 mt-lg-0">  
                            ...
                            <h2 class="font-Saravekreg" class="title font-Laurentiareg" style="color: #000000;">Acerca del curso</h2>
                                ...
                                por medio de una intensiva metodología de <i>"learning by doing"</i> y gracias a la tutoría continúa, 
                                se retroalimentarán los elementos a profundizar para la obtención de resultados satisfactorios 
                                en el simulador de certificación diseñado como entrenamiento.</p>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="font-Saravekreg">
                                                    ...
                                                    se apoyarán con Apex para determinar las automatizaciones de la lógica empresarial. 
                                                </p>
                                            </div>
                                        </div>
                                    </li>
            ...
            <div class="d-none d-sm-none d-md-block">
                <div class="row text-center" style="--bs-gutter-x:-25rem">
                    ...
                    <div class="col-md-4 col-lg-4 col-xs-12">
                        <h6 style="color:#000000">Mas de</h6>
                        <h2 class="banner-descripcion" style="color:#B69256"><span class="counter" style="font-size: 40px;color:#B69256 !important;">600</span></h2>
                        <h6 style="color:#000000">Ofertas de empleo en México</h6>
                    </div>
                    <div class="col-md-4 col-lg-4 col-xs-12">
                    ...
                    <div class="col-lg-10 offset-lg-1">
                        <div class="center-tabs">
                            <ul id="tabs" class="nav nav-tabs">
                                ...
                                <li class="nav-item">
                                    <a href="" data-target="#tab3" data-toggle="tab" class="nav-link"><span class="font-Saravekreg">Facilidades de pago</span></a>
                                </li>
                                <li class="nav-item">
                                    <a href="" data-target="#tab4" data-toggle="tab" class="nav-link"><span class="font-Saravekreg">Costo</span></a>
                                </li>                                
                            </ul>
                                                    ...
                                                    <ul class="single-list-wrap">
                                                        <li class="single-list-inner style-check-box-grid">
                                                            <div class="media">
                                                                ...
                                                                <div class="media-body">
                                                                    <p class="font-Saravekreg" style="line-height:24px">El objetivo del diagnóstico de competencias es identificar las habilidades y actitudes que se vinculan con los perfiles profesionales de una carrera exitosa en <b>Salesforce.</b></p>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li class="single-list-inner style-check-box-grid">
                                                            <div class="media">
                                                                ...
                                                                <div class="media-body">
                                                                    <p class="font-Saravekreg" style="line-height:24px">Al terminar este diagnóstico, te daremos una perspectiva con base en tus respuestas, para determinar si eres elegible o no para el curso.</p>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li class="single-list-inner style-check-box-grid">
                                                        ...
                                                        <div class="col-lg-7 col-md-6 col-xs-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-8 pl-0 curso-nombre my-auto">
                                                                    <h6 class="font-Saravekreg" style="line-height:22px;margin-bottom:0px;color:#333333"><b>Salesforce Developer<br> <span class="font-Saravekreg color-sf font-Saravekreg">Octubre 2022</span></b></h6>
                                                                </div>                                           
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row align-center pb-4">
                                        <div class="col-lg-7 col-md-7  col-xs-12 info pb-3 my-auto">
                                                <div class="text-center">
                                                    ...
                                                    <h4 class="font-Saravekreg">Salesforce <span style="color:#B69256">Developer</span></h4>
                                                </div>                                                                                         
                                        </div>
