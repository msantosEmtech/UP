...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Salesforce Developer - Emtech</title>
                ...
                <div class="col-lg-5 col-md-8 order-lg-12 align-self-center">
                    <div class="thumb b-animate-thumb">
                        <a href="" data-toggle="modal" data-target=".modalTrailer">
                            <img class="zoom" src="<?= base_url('assets/course/img/developer-t.png') ?>" alt="img">
                        </a>
                    </div>
                </div>
                <div class="col-lg-7 order-lg-1 align-self-center">
                    <div class="banner-inner text-center text-lg-left mt-5 mt-lg-0">
                        <h1 class="b-animate-2 title" style="line-height:1">
                            Salesforce <br>
                            <span class="color-sf font-Novbold">Developer</span>
                        </h1>
                        <h4 class="b-animate-2 font-Novreg">Conviérte en un experto en el desarrollo <br>de<span class="font-Novbold"> soluciones tecnológicas personalizadas.</span></h4>
                        <div class="mt-4">
                            <a class="btn btn-base b-animate-3" href="https://emtech.digital/salesforce-developer/?s=<?=$source?>&m=<?=$medium?>&c=<?=$canal?>">Aplicar</a>
                            <a class="btn btn-border-black m-2 b-animate-3" href="<?= base_url('SalesforceDeveloper/downloadSyllabus') ?>">Descargar Syllabus</a>                      
                        </div>
                                ...
                                <div class="card fondo-info">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-md-12 col-lg-7 my-auto info-text">
                                                <p><b>Duración:<br> 14 semanas</b></p>
                                            </div>                                           
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="about-area-inner">
                <div class="row">
                    <div class="col-lg-6 my-auto pl-0 pr-0">
                        <div class="left-icon">
                            <div class="about-icon"><img src="<?= base_url('assets/course/img/pc-curso-dev.png') ?>" alt="img"></div>
                        </div>
                    </div>
                    <div class="col-lg-6 my-auto">
                        <div class="about-inner-wrap pl-xl-4 pt-3 pt-lg-0 mt-lg-0">  
                            <div class="section-title mb-0">
                                ...
                                <h6 class="content font-Novreg" style="color:#333333;font-weight:500">El participante demostrará las competencias para aplicar a la certificación <span class="color-sf font-Novbold">"Salesforce Developer Platform I"</span> por medio de una intensiva metodología de "learning by doing" y gracias a la tutoría continúa, se retroalimentarán los elementos a profundizar para la obtención de resultados satisfactorios en el simulador de certificación diseñado como entrenamiento.</h6>
                                    ...
                                    <li class="single-list-inner style-check-box-grid">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="font-Novreg">Obtendrás el desarrollo de tus capacidades para la automatización de procesos declarativos dentro de la <span class="color-sf font-Novbold">plataforma Salesforce,</span> que se apoyarán con Apex para determinar las automatizaciones de la lógica empresarial. </p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="single-list-inner style-check-box-grid">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="font-Novreg">Incorporarás en la página de <span class="color-sf font-Novbold">Visualforce, las aplicaciones de la plataforma Lightning,</span> descubriendo el potencial de sus beneficios y los tipos de contenido que se pueden incluir en los componentes <span class="color-sf font-Novbold">web Lightning.</span> Realizar diferentes prácticas con las que podrás enfrentarte en el mundo laboral como desarrollador, con la finalidad de que puedas obtener un aprendizaje más significativo.</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="single-list-inner style-check-box-grid">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <a class="btn btn-base-s b-animate-3 mr-sm-3 mr-2" href="https://emtech.digital/salesforce-developer/?s=<?=$source?>&m=<?=$medium?>&c=<?=$canal?>" style="margin-top:10px">Aplicar</a>
                                            </div>
                                        </div>
                                    </li>                                    
                                </ul>
    ...
    <div class="mt-5 client-area bg-base pb-5 pt-5 img-fondo-info">
        <div class="container">
                ...
                <div class="d-none d-sm-none d-md-block">
                    <div class="row text-center" style="--bs-gutter-x:-25rem">                                    
                        <div class="col-md-4 col-lg-4 col-xs-12">
                            <h6 style="color:#FFFFFF">Más de</h6 >
                            <h2 class="banner-descripcion" style="color:#25C7D9"><span class="counter">600</span></h2>
                            <h6   style="color:#FFFFFF">Ofertas de empleo</h6 >
                        </div>
                        <div class="col-md-4 col-lg-4 col-xs-12">
                ...
                <div class="row text-center">                                    
                        ...
                        <hr>
                        <div class="col-12 pt-3 pb-3">
                            <h6 style="color:#FFFFFF">Sueldos de hasta</h6>
                            <h2 class="banner-descripcion" style="color:#25C7D9">$<span class="counter">40</span> mil</h2>
                            <h6 style="color:#FFFFFF">pesos por mes</h6 >
                        </div>
                        <hr>
                        <div class="col-12 pt-3 pb-3">
                                                        ...
                                                        <div class="col-lg-7 col-md-6 col-xs-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-8 pl-0 curso-nombre my-auto">
                                                                    <h6 class="font-Novbold" style="line-height:22px;margin-bottom:0px;color:#333333"><b>Salesforce Developer<br> <span class="font-Novbold color-sf font-Novbold">Octubre 2022</span></b></h6>
                                                                </div>                                           
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row align-center pb-4">
                                        <div class="col-lg-7 col-md-7  col-xs-12 info pb-3 my-auto">
                                                <div class="text-center">
                                                    ...
                                                    <h4>Salesforce <span style="color:#25C7D9">Developer</span></h4>
                                                </div>                                                                                         
                                        </div>
                                            ...
                                            <div class="about-inner-wrap pl-xl-4 pt-3 pt-lg-0 mt-lg-0">  
                                                <div class="section-title mb-0">
                                                    ...
                                                    <ul class="single-list-wrap">
                                                        ...
                                                        <a class="btn btn-base-s b-animate-3 ml-2" href="https://emtech.digital/salesforce-developer/?s=<?=$source?>&m=<?=$medium?>&c=<?=$canal?>">Aplicar</a>
                                                    </ul>
          ...
          <div class="modal-body mb-0 p-0">
            <div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
                <video width="320" height="240" controls>
                    <source src="<?= base_url('assets/videos/SFD_Trailer_v1.mp4') ?>" type="video/mp4">
                </video>                
            </div>
          </div>
        </div>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="border-radius:15px">
          ...
          <div class="modal-body">
            ...
            Para el curso de Salesforce Developer, debes estar familiarizado o tener conocimientos de lenguajes de programación como Apex, Visualforce, HTML y JavaScript. 
            Debes tener una base de programación orientada a objetos. Manejar servicios web, SQL, así como lenguaje de consulta de objetos de Salesforce.
          </div>
        </div>
      </div>
    </div>
