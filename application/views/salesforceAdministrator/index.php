                            ...
                            <div class="col-xs-12 col-md-6 col-lg-3 responsive-cards-course zoom">
                                <div class="card fondo-info">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-xs-12 col-md-12 col-lg-5 my-auto">
                                                <img class="p-2" src="<?= base_url('assets/course/img/i-3.png') ?>">
                                            </div>
                                            <div class="col-xs-12 col-md-12 col-lg-7 my-auto info-text">
                    ...
                    <div class="col-lg-6 my-auto">
                        <div class="about-inner-wrap pl-xl-4 pt-3 pt-lg-0 mt-lg-0">  
                            <div class="section-title mb-0">
                                ...
                                <h6 class="content font-Novreg" style="color:#333333;font-weight:500">Conviértete en un experto en implementación de la innovación digital de<span class="color-sf font-Novbold font-Novbold"> Salesforce,</span> gestionando las herramientas más importantes del ecosistema en cualquier industria, a través del rol <span class="color-sf font-Novbold">Salesforce Administrator.</span></h6>
                                    ...
                                    <li class="single-list-inner style-check-box-grid">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="font-Novreg">Desarrollarás habilidades técnicas para la certificación en Salesforce Administrator, y serás parte del impacto en los negocios en la automatización de procesos comerciales complejos, podrás entrenar a otros en el uso de la plataforma, crear reportes y tableros para mantener la <span class="color-sf font-Novbold font-Novbold">eficacia en el negocio.</span></span></p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="single-list-inner style-check-box-grid">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="font-Novreg">A través de los <span class="color-sf font-Novbold font-Novbold">9 módulos</span> que dura este curso, tendrás tutorías con expertos en este rol de Salesforce, así como ejercicios didácticos que consistirán en la profunda interacción de las plataformas digitales que ofrece Salesforce y con las que podrás brindar <span class="color-sf font-Novbold font-Novbold">soluciones más rápidas e inteligentes a diversos problemas que enfrentarás en el mundo real.</span></p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="single-list-inner style-check-box-grid">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <a class="btn btn-base-s b-animate-3 mr-sm-3 mr-2" href="https://emtech.digital/salesforce-admin/?s=<?=$source?>&m=<?=$medium?>&c=<?=$canal?>" style="margin-top:10px">Aplicar</a>
                                            </div>
                                        </div>
                                    </li>                                    
                                </ul>
        ...
        <div class="container">
                ...
                <div class="row text-center">                                    
                        <div class="col-12 pt-3 pb-3">
                            ...
                            <h2 class="banner-descripcion" style="color:#25C7D9"><span class="counter">85</span></h2>
                                                    ...
                                                    <ul class="single-list-wrap">
                                                        <li class="single-list-inner style-check-box-grid">
                                                            <div class="media">
                                                                ...
                                                                <div class="media-body">
                                                                    <p style="line-height:20px">El objetivo del diagnóstico de competencias es identificar las habilidades y actitudes que se vinculan con los perfiles profesionales de una carrera exitosa en Salesforce.</p>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li class="single-list-inner style-check-box-grid">
                                    ...
                                    <div class="row align-center pb-4">
                                        <div class="col-lg-7 col-md-7  col-xs-12 info pb-3 my-auto">
                                                <div class="text-center">
                                                    ...
                                                    <h4>Salesforce <span style="color:#25C7D9">Administrator</span></h4>
                                                </div>                                                                                         
                                        </div>
