            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-7 order-lg-1 align-self-center">
                    <div class="banner-inner text-center text-lg-left mt-5 mt-lg-0">
                        ...
                        <h4 class="b-animate-1" style="color:#000000;">Analiza y evalúa las tendencias de los datos<br> y crea <b>estrategias de negocio exitosas.</b></h4>
                        <div class="mt-4">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-md-12 col-lg-7 my-auto info-text">
                                                <p><b>Inicio:<br> Proximámente</b></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="font-Saravekreg">
                                                    ...
                                                    automatización de procesos comerciales complejos, entre muchos otros.
                                                </p>
                                            </div>
                                        </div>
                                    </li>
